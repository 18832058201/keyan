...
<script>
    ...
    function saveRewardResult() {
        ...
        if (confirm("确认保存该成果信息吗？")) {
            //修改提交地址为 save
            $("#rewardResultForm").attr("action", "<%=request.getContextPath()%>/result/rewardResult/updateRewardResult.action?submitType=save");
    ...
    function submitRewardResult() {
        ...
        if (confirm("确定提交该成果信息吗？")) {
            //修改提交地址为 submit
            $("#rewardResultForm").attr("action", "<%=request.getContextPath()%>/result/rewardResult/updateRewardResult.action?submitType=submit");
            $("#subForm").click(); //触发按钮提交事件
        }
    }
</script>
