...
//                    }
    ...
    function savePatentResult() {
        ...
        if (confirm("提示：确认保存吗？")) {
            //修改提交地址为 save
            $("#updatePatentResultForm").attr("action", "<%=request.getContextPath()%>/result/patentResult/updatePatentResult.action?submitType=save");
    ...
    function submitPatentResult() {
        ...
        if (confirm("提示：确认提交吗？")) {
            //修改提交地址为 submit
            $("#updatePatentResultForm").attr("action", "<%=request.getContextPath()%>/result/patentResult/updatePatentResult.action?submitType=submit");
            $("#subForm").click(); //触发按钮提交事件
        }
    }
</script>
