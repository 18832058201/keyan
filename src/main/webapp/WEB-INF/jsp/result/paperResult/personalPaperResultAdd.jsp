    ...
    <table style="table-layout:fixed;">
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input name="paperName" type="text" id="paperName" style="width: 500px;" required
                       onblur="nameIsExisted(this.value,'<%=request.getContextPath()%>/result/paperResult/paperNameIsExisted.action')">
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input name="publishName" type="text" style="width: 500px;" required>
                <label class="required">*</label>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="ibg">
                <select name="publishTypeId" class="select-min" required>
                    ...
                    <c:forEach items="${publishTypeList}" var="publishType">
                        <option value="${publishType.publishTypeId}">${publishType.publishTypeName}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
            ...
            <td colspan="4" class="ibg">
                <select name="publishLevelId" class="select-min" required>
                    ...
                    <c:forEach items="${publishLevelList}" var="publishLevel">
                        <option value="${publishLevel.publishLevelId}">${publishLevel.publishLevelName}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
            ...
            <td colspan="8" class="ibg">
                <select name="publishRangeId" class="select-min" required>
                    ...
                    <c:forEach items="${publishRangeList}" var="publishRange">
                        <option value="${publishRange.publishRangeId}">${publishRange.publishRangeName}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
        ...
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" style="width: 200px;" name="issn" required>
            </td>
            <td class="right left">CN号：</td>
            <td colspan="4" class="ibg">
                <input type="text" style="width: 200px;" name="cn" required>
            </td>
        </tr>
        <tr>
            <td class="right">卷号：</td>
            <td colspan="8" class="ibg">
                <input type="text" style="width: 200px;" name="reelNumber" required>
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input type="text" style="width: 200px;" name="issue" required>
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input type="text" style="width: 200px;" required name="pageNumber">
                <label class="required">*（格式如150-200）</label>
            </td>
        </tr>
        <tr>
            <td class="right">发表时间：</td>
            <td colspan="3" class="ibg">
            ...
            <td colspan="8" class="ibg">
                <div class="table-container">
                    <table style="border: 1px solid black;width: 100%;table-layout:fixed;" id="includeTable">
                        ...
                        <tbody>
                        <tr>
                            <td colspan="9" class="align-center"><label class="required">待审核的信息可以进行删除操作，已审核的信息无法操作！</label></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    function savePaperResult() {
        ...
        if (confirm("确认保存该成果信息吗？")) {
            //修改提交地址为 save
            $("#paperResultForm").attr("action", "<%=request.getContextPath()%>/result/paperResult/insertPaperResult.action?submitType=save");
    ...
    function submitPaperResult() {
        ...
        if (confirm("确定提交该成果信息吗？")) {
            //修改提交地址为 submit
            $("#paperResultForm").attr("action", "<%=request.getContextPath()%>/result/paperResult/insertPaperResult.action?submitType=submit");
            $("#subForm").click(); //触发按钮提交事件
        }
    }
</script>
