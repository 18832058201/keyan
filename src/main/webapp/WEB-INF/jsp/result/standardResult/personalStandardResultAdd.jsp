    ...
    <table style="table-layout:fixed;">
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" name="standNumber" style="width: 250px;"
            ...
            <td colspan="4" class="ibg">
                <select name="standStateId" class="select-min" required>
                    ...
                    <c:forEach items="${standStateList}" var="standState">
                        <option value="${standState.standStateId}">${standState.standStateName}</option>
                    </c:forEach>
                </select>
            ...
            <td colspan="3" class="ibg">
                <select name="standObjectId" class="select-min" required>
                    ...
                    <c:forEach items="${standObjectList}" var="standObject">
                        <option value="${standObject.standObjectId}">${standObject.standObjectName}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
            ...
            <td colspan="4" class="ibg">
                <select name="standBusinessId" class="select-min" required>
                    ...
                    <c:forEach items="${standBusinessList}" var="standBusiness">
                        <option value="${standBusiness.standBusinessId}">${standBusiness.standBusinessName}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
        ...
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" name="putUnderUnit" style="width: 200px;" required>
                <label class="required">*</label>
            </td>
            <td class="right left">提出单位：</td>
            <td colspan="4" class="ibg">
                <input type="text" name="proposeUnit" style="width: 200px;" required>
                <label class="required">*</label>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" name="draftUnit" style="width: 200px;" required>
                <label class="required">*</label>
            </td>
        ...
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" name="replaceStatus" style="width: 250px;" required>
                <label class="required">*</label>
            </td>
            ...
            <td colspan="4" class="ibg">
                <select name="standTypeId" class="select-min" required>
                    ...
                    <c:forEach items="${standTypeList}" var="standType">
                        <option value="${standType.standTypeId}">${standType.standTypeName}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
...
<script>
    ...
    function saveStandardResult() {
        ...
        if (confirm("确认保存该标准管理信息吗？")) {
            //修改提交地址为 save
            $("#standardResultForm").attr("action", "<%=request.getContextPath()%>/result/standardResult/insertStandardResult.action?submitType=save");
    ...
    function submitStandardResult() {
        ...
        if (confirm("确定提交该标准管理信息吗？")) {
            //修改提交地址为 submit
            $("#standardResultForm").attr("action", "<%=request.getContextPath()%>/result/standardResult/insertStandardResult.action?submitType=submit");
            $("#subForm").click(); //触发按钮提交事件
        }
    }
</script>
