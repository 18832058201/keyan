...
<br>
<%--按钮end--%>
<h1 class="title-h1">新增软件著作成果</h1>
<%--表单start--%>
<form action="" method="POST" id="ResultForm" enctype="multipart/form-data">
    <input type="submit" style="display: none" id="subForm">
    <table style="table-layout:fixed;">
        <tr>
            <td class="right">软件全称：</td>
            <td colspan="8" class="ibg">
                <input type="text" style="width: 500px;" name="softwareName"
                       onblur="nameIsExisted(this.value,'<%=request.getContextPath()%>/result/softwareResult/softwareNameIsExisted.action')"
                       required>
        ...
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" style="width: 200px;" name="softwareVersion" required>
                <label class="required">*</label>
            </td>
            <td class="right left">软件简称：</td>
            <td colspan="4" class="ibg">
                <input type="text" style="width: 300px;" name="softwareShortName" required>
                <label class="required">*</label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" style="width: 200px;" name="registerNumber" required>
                <label class="required">*</label>
            </td>
            <td class="right left">分类号：</td>
            <td colspan="4" class="ibg">
                <input type="text" style="width: 200px;" name="classifyNumber" required>
                <label class="required">*</label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" class="ibg">
                <input type="text" style="width: 200px;" name="programmingLanguage" required>
                <label class="required">*</label>
            </td>
            <td class="right left">代码行数：</td>
            <td colspan="4" class="ibg">
                <input type="number" style="width: 200px;" name="codeLine" required>
                <label class="required">*</label>
            </td>
        </tr>
        <tr>
...
<script>
    ...
    function saveResult() {
        ...
        if (confirm("确认保存该著作成果信息吗？")) {
            //修改提交地址为 save
            $("#ResultForm").attr("action", "<%=request.getContextPath()%>/result/softwareResult/insertSoftwareResult.action?submitType=save");
    ...
    function submitResult() {
        ...
        if (confirm("确定提交该专利成果信息吗？")) {
            //修改提交地址为 submit
            $("#ResultForm").attr("action", "<%=request.getContextPath()%>/result/softwareResult/insertSoftwareResult.action?submitType=submit");
            $("#subForm").click(); //触发按钮提交事件
        }
    }
