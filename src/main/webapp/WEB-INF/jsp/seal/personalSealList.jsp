                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title" style="line-height: 36px;"><span class="icon"><i class="icon-th"></i></span>
                            <label style="float:left;padding-top: 7px;padding-left: 20px;">公章申请列表，共有&nbsp;&nbsp;XXXX&nbsp;&nbsp;条数据</label>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered data-table" style="table-layout:fixed;">
                                ...
                                <tbody class="table">
                                <tr class="gradeX">
                                    <td><a href="personalSealInfo.jsp" >测试</a></td>
                                    <td>信息与电气工程学院</td>
                                    <td>测试人员</td>
                                    <td>学校公章</td>
                                    <td>5</td>
                                    ...
                                    <td>2017-06-09</td>
                                    <td>
                                        <a href="personalSealEdit.jsp">编辑</a>
                                        &nbsp;&nbsp;<a href="">删除</a><br><a href="">已使用</a></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
