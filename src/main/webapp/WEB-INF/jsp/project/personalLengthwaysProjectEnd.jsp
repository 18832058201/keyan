...
<br>
<%--按钮end--%>
<h1 class="title-h1">纵向项目结题信息录入</h1>
<br>
...
<form>
    ...
    <table style="table-layout:fixed;">
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input type="text" name="" style="width: 500px;">
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input type="text" style="width: 500px;" value="测试人员1,测试人员2,测试人员3">
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <label>验收通过<input type="radio" name="radio1" value="yes"></label>
                <label>验收不通过<input type="radio" name="radio1" value="no"></label>
                &nbsp;&nbsp;
                <label class="required">*</label>
            </td>
        </tr>
