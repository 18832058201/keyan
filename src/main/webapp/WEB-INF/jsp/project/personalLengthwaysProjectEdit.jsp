...
<script>
    ...
    function saveProject() {
        ...
        if(confirm("提示：确定保存吗？")){
            //修改提交地址为 save
            $("#projectForm").attr("action","<%=request.getContextPath()%>/project/updateLengthwaysProject.action?submitType=save");
    ...
    function submitProject() {
        ...
        if(confirm("提示：确认提交吗？")){
            //修改提交地址为 submit
            $("#projectForm").attr("action","<%=request.getContextPath()%>/project/updateLengthwaysProject.action?submitType=submit");
            $("#subForm").click(); //触发按钮提交事件
        }
    }
