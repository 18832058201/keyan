...
<div id="content">
    <form action="#" method="get" class="form-horizontal">
        <div id="content-header">
            ...
            <br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="personalCrosswiseProjectAdd.jsp" class="button button-primary button-rounded button-small">新增</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title" style="line-height: 36px;"><span class="icon"><i class="icon-th"></i></span>
                            <label style="float:left;padding-top: 7px;padding-left: 20px;">横向项目列表，共有&nbsp;&nbsp;XXXX&nbsp;&nbsp;条数据</label>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered data-table" style="table-layout:fixed;">
                                ...
                                <tbody class="table">
                                <tr class="gradeX">
                                    <td><a href="personalLengthwaysProjectInfo.jsp">测试</a></td>
                                    <td>纵向项目</td>
                                    <td>自科类</td>
                                    <td>测试人员</td>
                                    <td>园林与生态工程学院</td>
                                    ...
                                    <td>上传</td>
                                    <td>
                                        <a href="personalCrosswiseProjectEnd.jsp">结题</a><br>
                                        <a href="personalCrosswiseProjectEndEdit.jsp">结题编辑</a>
                                    </td>
                                    <td>
                                        <a href="personalCrosswiseProjectBudget.jsp">预算调整</a><br>
                                        <a href="personalCrosswiseProjectEdit.jsp">编辑</a>&nbsp;&nbsp;
                                        <a href="">删除</a>
                                    </td>
                                </tr>
                                <tr class="gradeX">
                                    <td><a href="personalCrosswiseProjectInfo.jsp">测试</a></td>
                                    <td>擦擦擦</td>
                                    <td>自科类</td>
                                    <td>测试人员</td>
                                    <td>园林与生态工程学院</td>
                                    ...
                                    <td>上传</td>
                                    <td>
                                        <a onclick="JqueryDialog.Open('结题', 'personalLengthwaysProjectEnd.jsp', 500, 600);">结题</a><br>
                                        <a href="personalLengthwaysProjectEndEdit.jsp">结题编辑</a>
                                    </td>
                                    <td><a href="personalLengthwaysProjectBudget.jsp">预算调整</a><br>
                                        <a href="personalLengthwaysProjectEdit.jsp">编辑</a>&nbsp;&nbsp;
                                        <a href="">删除</a></td>
                                </tr>
                                </tbody>
                            </table>
