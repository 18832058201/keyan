                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title" style="line-height: 36px;"><span class="icon"><i class="icon-th"></i></span>
                            <label style="float:left;padding-top: 7px;padding-left: 20px;">纵向项目结题列表，共有&nbsp;&nbsp;XXXX&nbsp;&nbsp;条数据</label>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered data-table" style="table-layout:fixed;">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;width: 10%;">验收单位</th>
                                    <th style="text-align: center;width: 8%;">验收形式</th>
                                    <th style="text-align: center;width: 10%;">完成人员</th>
                                    <th style="text-align: center;width: 7%;">验收结果</th>
                                    <th style="text-align: center;width: 7%;">验收时间</th>
