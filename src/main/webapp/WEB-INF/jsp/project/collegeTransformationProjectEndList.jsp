                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered data-table" style="table-layout:fixed;">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center;width: 10%;">验收形式</th>
                                <th style="text-align: center;width: 10%;">验收结果</th>
                                <th style="text-align: center;width: 15%;">完成人员</th>
                            ...
                            <tr class="gradeX">
                                ...
                                <td><a href="scientificSealSchoolInfo.jsp">测试信息与电气工程学院信息与电气工程学院信息与电气工程学院信息与电气工程学院信息与电气工程学院信息与电气工程学院</a></td>
                                <td>信息与电气工程学院</td>
                                <td>信息与电气工程学院</td>
                                <td>信息与电气工程学院</td>
                                <td>信息与电气工程学院</td>
                            ...
                            <tr class="gradeX">
                                <td><input type="checkbox" /></td>
                                <td>测试abc  dsad ad sa sda sad sa a  dsdad sa dsadsa </td>
                                <td>信息与电气工程学院</td>
                                <td>测试人员</td>
                                <td>学校公章</td>
                                <td>5</td>
