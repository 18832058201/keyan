...
<div style=" width:100%; text-align:center; margin-left:15px; margin-right:15px;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;第一部分：项目基本信息&nbsp;&nbsp;&nbsp;&nbsp;
    <c:if test="${auditType eq 1}">
    <a href="<%=request.getContextPath()%>/project/toEditLengthWaysProject.action?editType=audit&projectId=${projectInfo.projectId}"><label class="required">编辑此部分</label></a>
    </c:if>
    <hr size="3" class="hrLine" style="width:300px;" color="#EE7600" noshade/>
</div>
<br>
...
<form action="" method="post" id="subForm">
    ...
    <input type="hidden" name="auditObjectId" value="${projectInfo.projectId}"> <%--设置项目id--%>
</form>
<%--表单end--%>
...
<table style="table-layout:fixed;">
    ...
    <tr>
        ...
        <td colspan="4" class="ibg">&nbsp;&nbsp;
            <c:choose>
                <c:when test="${!empty projectInfo.attachment}">
                    <a href="<%=request.getContextPath()%>/file/fileDownload.action?fileName=${projectInfo.attachment}">下载</a>
                </c:when>
                <c:otherwise>
                    无
                </c:otherwise>
