...
<br>
<%--按钮end--%>
<h1 class="title-h1">新增科研管理费申请</h1>
<%--表单start--%>
    ...
    <table style="table-layout:fixed;">
            ...
            <td colspan="3" class="ibg">
                <select name="applyTypeId" id="applyTypeId" class="select-min" required>
                    ...
                    <c:forEach items="${applyTypeList}" var="applyType">
                        <option value="${applyType.applyTypeId}">${applyType.applyTypeName}</option>
                    </c:forEach>
                </select>
            ...
            <td colspan="4" class="ibg">
                <select name="applyYear" id="applyYear" class="select-min" required>
                    ...
                    <c:forEach items="${allYearList}" var="allYear">
                        <option value="${allYear.year}">${allYear.year}</option>
                    </c:forEach>
                </select>
                <label class="required">*</label>
            </td>
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input name="applyMoney" type="number" required
                       onblur="applyMoneyIsOut(this.value,'<%=request.getContextPath()%>/manageMoney/applyMoneyIsOut.action')">
                <label class="required">*（单位：元）（请选择申请类型和申请年限再输入金额）</label>
            </td>
        </tr>
        <c:if test="${exceptionMessage!=null}">
            <tr>
                <tb colspan="9" class="ibg">
                        &nbsp;&nbsp;${exceptionMessage}
                </tb>
            </tr>
        </c:if>
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <input list="auditPersonId1" name="auditPersonId1" style="width: 200px;" required/>
        ...
        <tr>
            ...
            <td colspan="4" class="ibg">
                <input list="auditPersonId2" name="auditPersonId2" style="width: 200px;"/>
        ...
        <tr>
            ...
            <td colspan="4" class="ibg">
                <input list="auditPersonId3" name="auditPersonId3" style="width: 200px;"/>
        ...
        <tr>
            ...
            <td colspan="8" class="ibg">
                <textarea style="width:80%;height: 100px;resize: none;" name="applyReason" required></textarea>
...
<script>
    ...
    function submitApply() {
        if (confirm("确定提交该申请信息吗？")) {
            //修改提交地址为 submit
            $("#applyForm").attr("action", "<%=request.getContextPath()%>/manageMoney/insertApply.action");
