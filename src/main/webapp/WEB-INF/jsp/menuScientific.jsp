...
<div id="sidebar" style="OVERFLOW-Y: auto; OVERFLOW-X:hidden;">
    <ul>
        ...
        <li class="submenu">
            ...
            <ul>
                <li><a class="menu_a" link="seal/schoolSealList.jsp"><i class="icon icon-caret-right"></i>学校公章</a></li>
                <li><a class="menu_a" link="seal/scientificSealList.jsp"><i class="icon icon-caret-right"></i>科研院公章</a></li>
                <li><a class="menu_a" link="seal/technologySealList.jsp"><i class="icon icon-caret-right"></i>技术转移中心公章</a></li>
            </ul>
        </li>
        <li class="submenu">
            <a href="#">
            ...
            <ul>
                <li><a class="menu_a" link="college/scientificCollegeList.jsp"><i class="icon icon-caret-right"></i> 学院列表</a></li>
            </ul>
        </li>
        <li class="submenu">
            <a href="#">
            ...
            <ul>
                <li><a class="mmm" listId="one" link="gallery.html"><i class="icon icon-caret-right"></i>纵向项目</a>
                    ...
                    <ul class="submenu" id="onem" style="display: none"><!-- 请看此处的id. -->
                        <li><a class="menu_a" link="<%=request.getContextPath()%>/audit/toLengthWaysProjectListAudit.action?auditType=1">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>项目列表</a></li>
                        <li><a class="menu_a" link="project/lengthwaysProjectEndList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>项目结题</a></li>
                        <li><a class="menu_a" link="project/lengthwaysProjectBudgetList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>预算调整</a></li>
                    </ul>
                </li>
                <li><a class="mmm" listId="two" link="calendar.html"><i class="icon icon-caret-right"></i>横向项目</a>
                    <ul class="submenu" id="twom" style="display: none"><!-- 请看此处的id. -->
                        <li><a class="menu_a" link="project/scientificCrosswiseProjectList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>项目列表</a></li>
                        <li><a class="menu_a" link="project/scientificCrosswiseProjectEndList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>项目结题</a></li>
                        <li><a class="menu_a" link="project/scientificCrosswiseProjectBudgetList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>预算调整</a></li>
                    </ul>
                </li>
                <li><a class="mmm" listId="three" link="invoice.html"><i class="icon icon-caret-right"></i>成果转化项目</a>
                    <ul class="submenu" id="threem" style="display: none"><!-- 请看此处的id. -->
                        <li><a class="menu_a" link="project/scientificTransformationProjectList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>项目列表</a></li>
                        <li><a class="menu_a" link="project/scientificTransformationProjectEndList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>项目结题</a></li>
                        <li><a class="menu_a" link="project/scientificTransformationProjectBudgetList.jsp">&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon icon-caret-right"></i>预算调整</a></li>
                    </ul>
                </li>
            </ul>
        </li>
        ...
        <li class="submenu">
            ...
            <ul>
                <li><a class="menu_a" link="error403.html"><i class="icon icon-caret-right"></i>考核统计</a></li>
                <li><a class="menu_a" link="error404.html"><i class="icon icon-caret-right"></i>科研业绩考核统计</a></li>
            </ul>
        </li>
    </ul>
</div>
...
<div id="content">
    ...
    <!--End-breadcrumbs-->
    <iframe src="<%=request.getContextPath()%>/scientificIndex.action" id="iframe-main" frameborder='0' style="width:100%;"></iframe>
</div>
